    ...
    <div className="row">
        ...
        <div className="col col--4">
            <div className="col-demo">
                ...
                Salesforce offers another system for B2B scenarios
            </div>
        </div>
        <div className="col col--4">
            <div className="col-demo">
...
<div className="container">
    <div className="row">
        <div className="col col--4">
            <div className="col-demo">
                <FeatureTable name="Salesforce B2C Commerce"
        ...
        <div className="col col--4">
            <div className="col-demo">
                <FeatureTable name="Salesforce B2C Commerce" cols="Merchant Portal, Multi-Merchant"/>
            </div>
        </div>
    </div>
